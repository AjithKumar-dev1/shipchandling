...
public class ArSchSalesInvoiceController {
    ...
    @Operation(
            ...
            description = "Creates a new Sales Invoice (Ship Chandling). DocRef is auto-generated. Calls stored procedures for validation and authorization.",
            responses = {
    ...
    @Operation(
            ...
            description = "Retrieves a sales invoice by transaction POID. Optionally includes detail tables.",
            responses = {
    ...
    @Operation(
            ...
            description = "Updates an existing sales invoice. Cannot update if verified. Calls stored procedures for validation.",
            responses = {
    ...
    @Operation(
            ...
            description = "Deletes a sales invoice (soft delete). Checks dependencies before deletion.",
            responses = {
    ...
    @Operation(
            ...
            description = "Retrieves all sales invoices with optional filtering by status, customer, date range, etc.",
            responses = {
    ...
    public ResponseEntity<?> getAllSalesInvoices(
        ...
        List<ArSchSalesInvoiceHdrDto> invoices = invoiceService.getAllSalesInvoices(
                ...
                partyType, fromDate, toDate, search);
    ...
    @Operation(
            summary = "Add Invoice Item Detail",
            description = "Adds a new item detail to the sales invoice. Auto-populates tax percentage if tax is selected."
    )
    ...
    public ResponseEntity<?> addItemDetail(
        ...
        ArSchSalesInvoiceDtlDto dto = invoiceService.addItemDetail(
                transactionPoid, request, groupPoid, companyPoid, userId);
        return success("Item detail added successfully", dto);
    }

    @Operation(
            summary = "Update Invoice Item Detail",
            description = "Updates an existing invoice item detail. Cannot update if invoice is verified."
    )
    ...
    public ResponseEntity<?> updateItemDetail(
        ...
        ArSchSalesInvoiceDtlDto dto = invoiceService.updateItemDetail(
                transactionPoid, detRowId, request, groupPoid, companyPoid, userId);
        return success("Item detail updated successfully", dto);
    }

    @Operation(
            summary = "Delete Invoice Item Detail",
            description = "Deletes an invoice item detail. Cannot delete if invoice is verified."
    )
    ...
    public ResponseEntity<?> deleteItemDetail(
        ...
        invoiceService.deleteItemDetail(transactionPoid, detRowId, groupPoid, companyPoid);
        return success("Item detail deleted successfully", null);
    }

    @Operation(
            summary = "Get Invoice Item Details",
            description = "Retrieves all item details for a sales invoice."
    )
    ...
    public ResponseEntity<?> getItemDetails(
        ...
        List<ArSchSalesInvoiceDtlDto> itemDetails = invoiceService.getItemDetails(
    ...
    @Operation(
            summary = "Add Delivery Note Detail",
            description = "Adds a delivery note reference to the sales invoice."
    )
    ...
    @Operation(
            summary = "Update Delivery Note Detail",
            description = "Updates an existing delivery note detail. Cannot update if invoice is verified."
    )
    ...
    @Operation(
            summary = "Delete Delivery Note Detail",
            description = "Deletes a delivery note detail. Cannot delete if invoice is verified."
    )
    ...
    @Operation(
            ...
            description = "Retrieves all delivery note details for a sales invoice."
    )
    ...
    @Operation(
            summary = "Get Cost Booked Details",
            description = "Retrieves all cost booked details for a sales invoice. This is a read-only table."
    )
    ...
    public ResponseEntity<?> getCostBookedDetails(
        ...
        List<ArSchSalesInvCostbkdDtlDto> costBookedDetails = invoiceService.getCostBookedDetails(
                transactionPoid, groupPoid, companyPoid);
    ...
    @Operation(
            summary = "Calculate GP",
            description = "Calculates Gross Profit for the invoice. Calls PROC_AR_SCH_GP_CALC."
    )
    ...
    @Operation(
            ...
            description = "Calculates due date from transaction date and credit days. Calls PROC_CALC_DUEDAYS."
    )
    ...
    @Operation(
            summary = "Calculate Item Discount/Commission",
            description = "Calculates discount and commission for an invoice item. Calls PROC_AR_SCH_DIS_COM_CAL."
    )
    ...
    public ResponseEntity<?> calculateItemDiscountCommission(
        ...
        CalculateDiscountCommissionResponse response = invoiceService.calculateItemDiscountCommission(
                transactionPoid, detRowId, request.getIncentiveAmt(), request.getIncentiveAmt2(), 
                request.getIncentiveAmt3(), request.getIncentivePercent(), request.getIncentivePercent2(), 
                request.getIncentivePercent3(), request.getBaseAmt(), groupPoid);
        return success(response.getMessage(), response);
    }

    @Operation(
            summary = "Calculate Header Discount/Commission",
            description = "Calculates discount and commission at header level. Calls PROC_AR_SCH_DIS_COM_CAL_HDR."
    )
    ...
    @Operation(
            summary = "Load Quotation",
            description = "Loads quotation items into invoice. Invoice details table must be empty. Calls PROC_AR_SCH_QTN_LOAD_BUTTON."
    )
    ...
    public ResponseEntity<?> loadQuotation(
        ...
        LoadQuotationResponse response = invoiceService.loadQuotation(
                transactionPoid, request.getQtnPoid(), request.getIncentiveAmt(), 
    ...
    @Operation(
            summary = "Load Delivery Note",
            description = "Loads delivery note items into invoice. Delivery notes must be selected first. Invoice details table must be empty. Calls PROC_AR_SCH_SALESINV_DN_LOAD."
    )
    ...
    @Operation(
            summary = "Unload Quotation",
            description = "Unloads/clears quotation details from invoice. Calls PROC_AR_SCH_UNLOAD_QUOTATION1."
    )
    ...
    @Operation(
            summary = "Load Cost Bookings",
            description = "Loads cost booking details into the invoice. Calls PROC_AR_SCH_SALES_INV_PJ_LOAD1."
    )
    ...
    @Operation(
            ...
            description = "Verifies the invoice. Once verified, invoice cannot be edited."
    )
    ...
    @Operation(
            ...
            description = "Validates customer credit details. Calls PROC_VALIDATE_CUSTOMER."
    )
    ...
    @Operation(
            summary = "Load Credit Details",
            description = "Loads customer credit details (credit days, payment mode, etc.). Calls PROC_LOAD_CREDIT_DETAILS."
    )
    ...
    @Operation(
            summary = "Load Quotation Currency",
            description = "Loads currency code and rate from quotation. Calls PROC_AR_SCH_QTN_LOAD_CUR1."
    )
    ...
    @Operation(
            summary = "Check Sales Invoice Dependencies",
            description = "Checks if invoice can be deleted by checking for dependencies (receipts, credit notes, GL postings)."
    )
