...
public class ArSchSalesInvoiceServiceImpl implements ArSchSalesInvoiceService {
    ...
    if (includeDetails) {
        List<ArSchSalesInvoiceDtl> details = invoiceDtlRepository.findByTransactionPoid(invoice.getTransactionPoid());
        ...
        List<ArSchSalesInvCostbkdDtl> costDetails = costbkdDtlRepository.findByTransactionPoid(invoice.getTransactionPoid());
    ...
    public void deleteSalesInvoice(Long transactionPoid, Long groupPoid, Long companyPoid) {
        ...
        // Check dependencies
        SalesInvoiceDependenciesDto dependencies = checkSalesInvoiceDependencies(transactionPoid, groupPoid, companyPoid);
    ...
    public ValidationResponse validateDocRef(String docRef, Long groupPoid, Long companyPoid, Long transactionPoid) {
        ...
        if (transactionPoid != null) {
            ...
            exists = invoiceHdrRepository.existsByDocRefIgnoreCaseAndGroupPoidAndCompanyPoid(docRef, groupPoid, companyPoid);
        }
    ...
    public LoadQuotationResponse loadQuotation(Long transactionPoid, LoadQuotationRequest request, 
        ...
        if (!existingDetails.isEmpty()) {
            throw new CustomException("Cannot load quotation. Invoice details table is not empty. Please clear items first.");
        }
    ...
    public LoadDeliveryNoteResponse loadDeliveryNote(Long transactionPoid, Long groupPoid, 
        ...
        List<ArSchSalesInvoiceDtl> existingDetails = invoiceDtlRepository.findByTransactionPoid(transactionPoid);
        if (!existingDetails.isEmpty()) {
            throw new CustomException("Cannot load delivery note. Invoice details table is not empty. Please clear items first.");
        }

        // Check if delivery note details exist
        List<ArSchSalesDnDtl> dnDetails = dnDtlRepository.findByTransactionPoid(transactionPoid);
        if (dnDetails.isEmpty()) {
            throw new CustomException("No delivery notes selected. Please select delivery notes in Delivery Note Details tab first.");
        }
    ...
    public CalculateDiscountCommissionResponse calculateItemDiscountCommission(Long transactionPoid, Long detRowId, 
        ...
        response.setSuccess(true);
        response.setMessage(result.getResult() != null ? result.getResult() : "Discount/commission calculated successfully");
    ...
    @Override
    @Transactional
    public LoadDeliveryNoteResponse loadDeliveryNote(Long transactionPoid, Long groupPoid, Long companyPoid, String userId) {
        // Validate invoice exists
        ArSchSalesInvoiceHdr invoice = invoiceHdrRepository
                .findByTransactionPoidAndGroupPoidAndCompanyPoid(transactionPoid, groupPoid, companyPoid)
                .orElseThrow(() -> new ResourceNotFoundException("Sales Invoice", "transactionPoid", transactionPoid));
        ...
        List<ArSchSalesInvoiceDtl> existingItems = invoiceDtlRepository.findByTransactionPoid(transactionPoid);
        if (!existingItems.isEmpty()) {
            throw new CustomException("Cannot load delivery note. Invoice already has items. Please clear items first.");
        }
    ...
    @Override
    @Transactional
    public UnloadQuotationResponse unloadQuotation(Long transactionPoid, Long groupPoid, Long companyPoid, String userId) {
        // Validate invoice exists
        ArSchSalesInvoiceHdr invoice = invoiceHdrRepository
                .findByTransactionPoidAndGroupPoidAndCompanyPoid(transactionPoid, groupPoid, companyPoid)
                .orElseThrow(() -> new ResourceNotFoundException("Sales Invoice", "transactionPoid", transactionPoid));
    ...
    @Override
    @Transactional(readOnly = true)
    public SalesInvoiceDependenciesDto checkSalesInvoiceDependencies(Long transactionPoid, Long groupPoid, Long companyPoid) {
        // Validate invoice exists
        ArSchSalesInvoiceHdr invoice = invoiceHdrRepository
                .findByTransactionPoidAndGroupPoidAndCompanyPoid(transactionPoid, groupPoid, companyPoid)
                .orElseThrow(() -> new ResourceNotFoundException("Sales Invoice", "transactionPoid", transactionPoid));
    ...
    private String callCalculateGpProcedure(Long transactionPoid, Long groupPoid) {
        ...
        // Parameters: P_TRANSACTION_POID, P_GROUP_POID (optional), P_RESULT (OUT VARCHAR)
    ...
    private Timestamp callCalculateDueDateProcedure(Long groupPoid, Long companyPoid, 
        ...
        // Parameters: P_GROUP_POID, P_COMPANY_POID, P_TRANSACTION_DATE, P_CREDIT_DAYS, P_DUE_DATE (OUT DATE), P_RESULT (OUT VARCHAR)
        // Return due date
        return null;
    }
    ...
    private DiscountCommissionResult callCalculateItemDiscountCommissionProcedure(Long transactionPoid, Long detRowId,
        ...
        // Parameters: P_TRANSACTION_POID, P_DET_ROW_ID, P_INCENTIVE_AMT, P_INCENTIVE_AMT2, P_INCENTIVE_AMT3,
    ...
    private QuotationLoadResult callLoadQuotationProcedure(Long transactionPoid, Long qtnPoid,
        ...
        // Parameters: P_TRANSACTION_POID, P_QTN_POID, P_INCENTIVE_AMT, P_INCENTIVE_AMT2, P_INCENTIVE_AMT3, P_RESULT (OUT VARCHAR), P_CURSOR (OUT CURSOR)
    ...
    private String callValidateCustomerProcedure(Long groupPoid, Long companyPoid, Long customerPoid) {
        ...
        // Parameters: P_GROUP_POID, P_COMPANY_POID, P_CUSTOMER_POID, P_RESULT (OUT VARCHAR)
        // Return result string
        return null;
    }
    ...
    private CreditDetailsResult callLoadCreditDetailsProcedure(Long groupPoid, Long companyPoid, Long customerPoid) {
        ...
        // Parameters: P_GROUP_POID, P_COMPANY_POID, P_CUSTOMER_POID, P_CREDIT_DAYS (OUT), P_DUE_DATE (OUT), 
    ...
    private QuotationCurrencyResult callLoadQuotationCurrencyProcedure(Long qtnPoid) {
        ...
        // Parameters: P_QTN_POID, P_CURRENCY_CODE (OUT VARCHAR), P_CURRENCY_RATE (OUT NUMERIC), P_RESULT (OUT VARCHAR)
    ...
    private static class DiscountCommissionResult {
        ...
        public void setNetSales(Long netSales) { this.netSales = netSales; }
        public Long getIncentive() { return incentive; }
        public void setIncentive(Long incentive) { this.incentive = incentive; }
    ...
    private static class QuotationLoadResult {
        ...
        // Getters and setters
        public Long getIncentiveAmt() { return incentiveAmt; }
        public void setIncentiveAmt(Long incentiveAmt) { this.incentiveAmt = incentiveAmt; }
        public Long getIncentiveAmt2() { return incentiveAmt2; }
        public void setIncentiveAmt2(Long incentiveAmt2) { this.incentiveAmt2 = incentiveAmt2; }
        public Long getIncentiveAmt3() { return incentiveAmt3; }
        public void setIncentiveAmt3(Long incentiveAmt3) { this.incentiveAmt3 = incentiveAmt3; }
        public String getResult() { return result; }
        public void setResult(String result) { this.result = result; }
    }
    ...
    private static class CreditDetailsResult {
        ...
        // Getters and setters
        public Long getCreditDays() { return creditDays; }
        public void setCreditDays(Long creditDays) { this.creditDays = creditDays; }
        ...
        public void setOutstandingAmount(Long outstandingAmount) { this.outstandingAmount = outstandingAmount; }
        public String getResult() { return result; }
        public void setResult(String result) { this.result = result; }
    }
    ...
    private static class QuotationCurrencyResult {
        ...
        public Long getCurrencyRate() { return currencyRate; }
        public void setCurrencyRate(Long currencyRate) { this.currencyRate = currencyRate; }
        public String getResult() { return result; }
        public void setResult(String result) { this.result = result; }
    }
